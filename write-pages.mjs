...
// ABOUT PAGE
// ============================================================
const aboutContent = `import { useEffect, useRef, useState, useLayoutEffect } from 'react';
...
writeFileSync('src/pages/About.tsx', aboutContent, 'utf8');
console.log('About.tsx written:', aboutContent.length, 'bytes');
