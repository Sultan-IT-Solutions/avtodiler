...
export const InlineCmsCollectionMenu = ({
  ...
  return (
    <div
      className="fixed inset-0 z-[78] flex items-center justify-center bg-black/70 px-4 py-8"
      onClick={onClose}
    >
      <div
        className="max-h-[86vh] w-full max-w-3xl overflow-y-auto border border-white/10 bg-luxury-elevated p-6 shadow-2xl lg:p-8"
